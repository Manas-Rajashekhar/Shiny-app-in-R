  ...
  sidebarLayout(
    sidebarPanel(
      ...
      mainPanel(
        ...
        tabsetPanel(
          tabPanel("Percentage of bleaching over the years", plotOutput("percentage_of_bleaching", width =  450 , height = 450)), 
          tabPanel("Map", leafletOutput(outputId = "great_barrier_reef" , width = 450, height = 450))
